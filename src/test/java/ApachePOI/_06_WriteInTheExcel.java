...
import org.apache.poi.ss.usermodel.*; // yıldız koymamızın sebebi hepsinde geçerli olmasını istemem
                                    // workbook, sheet, row ...
...
public class _06_WriteInTheExcel {
    public static void main(String[] args) throws IOException {
        ...
        Row yeniSatir= sheet.createRow(sheet.getPhysicalNumberOfRows());
                                   // üstte ki paranteze 0 yerine yukarıdaki kodu yazarsam
                                   // (sheet.getPhysicalNumberOfRows())
                                   // her çalıştırmada alt satıra geçer ve yazar.
                                  // böylelikle aynı hücreye tekrar tekrar yazdırmamış olurum.
        ...
        // resource class da ki ilgili excel in [0][0] (A-1) hücresine yazdırdım.
    }
}
