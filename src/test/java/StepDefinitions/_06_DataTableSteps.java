...
public class _06_DataTableSteps {
    ...
    public void clickOnTheElementInLeftNav(DataTable items) {
       ...
       for (String strButton: strButtons) {
           WebElement element=ln.getWebElement(strButton); // WebElement i bul
           ln.clickFunction(element);                    // WebElement e tıkla
       }
    }
    ...
    public void clickOnTheElementInDialog(DataTable dt) {
        ...
        for (String strButton: strButtons) {
            WebElement element=dc.getWebElement(strButton); // WebElement i bul
            dc.clickFunction(element); // WebElement e tıklat
        }
    }
